...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO blog (`uid`, bcontent) VALUES (%s, %s)",
                       GetSQLValueString($_POST['mid'], "text"),
                       GetSQLValueString($_POST['bcontent'], "text"));
...
if(isset($_SESSION['mid'])){	
	header('location: discuss.php?mid='. $_SESSION['mid']); 
}else{	
	header('location: discuss.php?mid=0'); 
}
                        ...
                        <table width="100%" border="0px" cellpadding="0px" cellspacing="0px">
                        	<tr>
                                ...
                                <td valign="top" align="left">
                                    ...
                                    <table width="100%" border="0px" cellpadding="0px" cellspacing="0px" >
                                    	<tr>
                                        	<td><!-- InstanceBeginEditable name="EditRegion" -->                <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                                                <table align="center">
                                                  <tr valign="baseline">
                                                    <td align="right" valign="top" nowrap="nowrap">網誌內容:</td>
                                                    <td><textarea name="bcontent" cols="60" rows="20"></textarea></td>
                                                  </tr>
                                                  <tr valign="baseline">
                                                    <td nowrap="nowrap" align="right">&nbsp;</td>
                                                    <td><input type="submit" value="發表" /></td>
                                                  </tr>
                                                </table>
                                            <input type="hidden" name="mid" value="<?php if(isset($_SESSION['mid']))echo $_SESSION['mid']; else echo '0';?>" />
